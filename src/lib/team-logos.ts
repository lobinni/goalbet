...
const FOOTBALL_DATA_CRESTS: Record<string, number> = {
  // Premier League
  MCI: 65, LIV: 64, ARS: 57, CHE: 61, MUN: 66,
  TOT: 73, NEW: 67, AVL: 58, WHU: 563, BHA: 397,
  BRE: 402, FUL: 63, CRY: 354, WOL: 76, EVE: 62,
  NFO: 351, BOU: 1044, LEI: 338, IPS: 349, SOU: 340,
  // La Liga
  RMA: 86, FCB: 81, BAR: 81, ATM: 78, SEV: 559,
  BET: 90, RSO: 92, VIL: 94, ATH: 77, VAL: 95,
  // Bundesliga
  BAY: 5, BVB: 4, RBL: 721, B04: 3, BMG: 18,
  FRK: 19, WOB: 11, SCF: 17, SGE: 19, TSG: 2,
  // Serie A
  JUV: 109, MIL: 98, INT: 108, NAP: 113, ROM: 100,
  LAZ: 110, FIO: 99, ATA: 102, TOR: 586, BOL: 103,
  // Ligue 1
  PSG: 524, MON: 548, LYO: 523, LIL: 521, OLM: 516,
  REN: 529, NIC: 522, LEN: 541, STR: 576, NAN: 543,
};
...
const TEAM_NAME_TO_CODE: Record<string, string> = {
  ...
  "atletico madrid": "ATM", "sevilla": "SEV",
  "real betis": "BET", "real sociedad": "RSO",
  "villarreal": "VIL", "athletic bilbao": "ATH", "athletic club": "ATH",
  "valencia": "VAL",
  ...
  "atalanta": "ATA", "torino": "TOR", "bologna": "BOL",
  ...
  "rennes": "REN", "nice": "NIC", "ogc nice": "NIC",
  "lens": "LEN", "rc lens": "LEN",
  "strasbourg": "STR", "nantes": "NAN", "fc nantes": "NAN",
  "france": "FRA", "germany": "GER", "spain": "ESP",
  "england": "ENG", "italy": "ITA", "portugal": "POR",
  "netherlands": "NED", "belgium": "BEL", "croatia": "CRO",
  "argentina": "ARG", "brazil": "BRA", "uruguay": "URU",
  "colombia": "COL", "japan": "JPN", "south korea": "KOR",
  "australia": "AUS", "usa": "USA", "mexico": "MEX",
  "morocco": "MAR", "senegal": "SEN", "nigeria": "NGA",
  "ivory coast": "CIV", "dr congo": "COD",
  "norway": "NOR", "sweden": "SWE", "denmark": "DEN",
  "switzerland": "SUI", "austria": "AUT", "poland": "POL",
  "czech republic": "CZE", "ukraine": "UKR", "turkey": "TUR",
  "canada": "CAN",
};
