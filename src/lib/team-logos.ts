...
const NATIONAL_TEAM_COUNTRY: Record<string, string> = {
  ...
  PER: "pe", PAR: "py", ECU: "ec",
  MEX: "mx", USA: "us", CAN: "ca",
  JPN: "jp", KOR: "kr", AUS: "au", QAT: "qa",
  MAR: "ma", SEN: "sn", NGA: "ng", CIV: "ci", COD: "cd",
  NOR: "no", SWE: "se", DEN: "dk", SUI: "ch", AUT: "at",
  POL: "pl", CZE: "cz", UKR: "ua", TUR: "tr",
  WAL: "gb-wls", SCO: "gb-sct", BIH: "ba",
};
...
const TEAM_NAME_TO_CODE: Record<string, string> = {
  ...
  "atletico madrid": "ATM",
  "sevilla": "SEV", "real betis": "BET",
  "real sociedad": "RSO", "villarreal": "VIL",
